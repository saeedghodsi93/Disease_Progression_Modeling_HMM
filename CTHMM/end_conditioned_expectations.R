...
cthmm.calc.integral.func <- function(I, Q.in, l.in, tau.in) {
...
cthmm.end.conditioned.expectations.func <- function(I, Q.in, l.in, tau.in) {
  
  # evaluate the integral
  integral.mat <- cthmm.calc.integral.func(I, Q.in, l.in, tau.in)
