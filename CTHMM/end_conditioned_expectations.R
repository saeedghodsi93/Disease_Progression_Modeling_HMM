...
calc.integral.func <- function(I, Q.in, l.in, tau.in) {
...
end.conditioned.expectations.func <- function(I, Q.in, l.in, tau.in) {
  
  # evaluate the integral
  integral.mat <- calc.integral.func(I, Q.in, l.in, tau.in)
