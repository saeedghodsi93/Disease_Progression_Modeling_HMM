...
# EM algorithm
cthmm.ext1.EM.algorithm.func <- function(N, I, J, L, H, a, tau.obs, y.obs, u.obs, pi.init, Q.init, mu.init, eta.init, counter.em.max, debugging.mode) {
  ...
  while (TRUE) {
    ...
    # E-step 
    ret.E.step <- cthmm.ext1.E.step.func(N, I, J, L, H, a, tau.obs, y.obs, u.obs, pi.tilde, Q.tilde, mu.tilde, eta.tilde)
    ...
    # M-step
    ret.M.step <- cthmm.ext1.M.step.func(I, J, L, sufficient.pi, sufficient.Q, sufficient.mu, sufficient.eta)
